...
```
    ...
    ## INFO [2025-01-30 20:44:40] Starting logging
...
```
    ...
    ## INFO [2025-01-30 20:44:43] Corner detected correctly at row 8, column N
    ## INFO [2025-01-30 20:44:43] 
    ## Extracting sample information from rows 1 to 8 and columns O to DC
    ## INFO [2025-01-30 20:44:43] Replacing spaces in sample information column names with underscores (_)
    ## INFO [2025-01-30 20:44:43] Naming the last column of sample information "Datafile"
    ## INFO [2025-01-30 20:44:43] 
    ## Extracting feature information from rows 9 to 5104 and columns A to N
    ## INFO [2025-01-30 20:44:43] Creating Split column from Column, Ion mode
    ## INFO [2025-01-30 20:44:43] Feature_ID column not found, creating feature IDs
    ## INFO [2025-01-30 20:44:43] Identified m/z column mass and retention time column rt
    ## INFO [2025-01-30 20:44:43] Identified m/z column mass and retention time column rt
    ## INFO [2025-01-30 20:44:43] Creating feature IDs from Split, m/z and retention time
    ## INFO [2025-01-30 20:44:43] Replacing dots (.) in feature information column names with underscores (_)
    ## INFO [2025-01-30 20:44:43] 
    ## Extracting feature abundances from rows 9 to 5104 and columns O to DC
    ## INFO [2025-01-30 20:44:43] 
    ## Checking sample information
    ## INFO [2025-01-30 20:44:43] QC column generated from rows containing 'QC'
    ## INFO [2025-01-30 20:44:43] Sample ID autogenerated from injection orders and prefix ID_
    ## INFO [2025-01-30 20:44:43] Checking that feature abundances only contain numeric values
    ## INFO [2025-01-30 20:44:44] 
    ## Checking feature information
    ## INFO [2025-01-30 20:44:44] Checking that feature IDs are unique and not stored as numbers
    ## INFO [2025-01-30 20:44:44] Checking that m/z and retention time values are reasonable
    ## INFO [2025-01-30 20:44:44] Identified m/z column mass and retention time column rt
    ## INFO [2025-01-30 20:44:44] Identified m/z column mass and retention time column rt
...
```
    ...
    ## Checking feature information
    ## INFO [2025-01-30 20:44:44] Checking that feature IDs are unique and not stored as numbers
    ## INFO [2025-01-30 20:44:44] Checking that feature abundances only contain numeric values
    ## INFO [2025-01-30 20:44:44] Setting row and column names of exprs based on feature and pheno data
...
```
    ...
    ## INFO [2025-01-30 20:44:46] 
    ## Starting drift correction at 2025-01-30 20:44:46.270141
    ## INFO [2025-01-30 20:45:44] Drift correction performed at 2025-01-30 20:45:44.425468
    ## INFO [2025-01-30 20:45:51] Inspecting drift correction results 2025-01-30 20:45:51.342863
    ## INFO [2025-01-30 20:46:26] Drift correction results inspected at 2025-01-30 20:46:26.525876
    ## INFO [2025-01-30 20:46:26] 
...
```
    ...
    ## INFO [2025-01-30 20:46:34] Identified m/z column mass and retention time column rt
    ## INFO [2025-01-30 20:46:34] 
    ## Starting feature clustering at 2025-01-30 20:46:34.608338
    ## INFO [2025-01-30 20:46:34] Finding connections between features in Rtx5MS_EI
    ## [1] 100
    ## [1] 200
    ## [1] 300
    ## [1] 400
    ...
    ## [1] 2200
    ## [1] 2300
    ## INFO [2025-01-30 20:50:17] Found 654 connections in Rtx5MS_EI
    ## INFO [2025-01-30 20:50:17] Found 654 connections
    ...
    ## 4 components found
    ## 
    ## INFO [2025-01-30 20:50:18] Found 267 clusters of 2 or more features, clustering finished at 2025-01-30 20:50:18.093121
...
```
    ...
    ## INFO [2025-01-30 20:50:18] Clusters compressed, left with 1939 features
...
```
    ...
    ## INFO [2025-01-30 20:50:21] 
    ## Starting random forest imputation at 2025-01-30 20:50:21.295304
    ## INFO [2025-01-30 20:51:15] Out-of-bag error in random forest imputation: 0.324
    ## INFO [2025-01-30 20:51:15] Random forest imputation finished at 2025-01-30 20:51:15.210387
...
```
    ...
    ## INFO [2025-01-30 20:51:15] 
    ## Starting random forest imputation at 2025-01-30 20:51:15.213388
    ## INFO [2025-01-30 20:51:15] Out-of-bag error in random forest imputation: 0
    ## INFO [2025-01-30 20:51:15] Random forest imputation finished at 2025-01-30 20:51:15.275391
...
```
    ...
    ## INFO [2025-01-30 20:51:17] Starting PQN normalization
    ## INFO [2025-01-30 20:51:17] Using median of qc samples as reference spectrum
...
```
    ...
    ## INFO [2025-01-30 20:51:25] Starting homoscedasticity tests.
    ## INFO [2025-01-30 20:51:41] Homoscedasticity tests performed.
...
```
    ...
    ## INFO [2025-01-30 20:51:41] Starting to compute fold changes.
    ## INFO [2025-01-30 20:51:42] Fold changes computed.
...
```
    ...
    ## INFO [2025-01-30 20:51:42] Starting t-tests for Light & Shade
    ## INFO [2025-01-30 20:51:49] t-tests performed.
...
```
    ...
    ## INFO [2025-01-30 20:51:51] Starting homoscedasticity tests.
    ## INFO [2025-01-30 20:52:08] Homoscedasticity tests performed.
...
```
    ...
    ## INFO [2025-01-30 20:52:08] Starting to compute fold changes.
    ## INFO [2025-01-30 20:52:08] Fold changes computed.
...
```
    ...
    ## INFO [2025-01-30 20:52:08] Starting t-tests for Light & Shade
    ## INFO [2025-01-30 20:52:13] t-tests performed.
...
```
    ...
    ## INFO [2025-01-30 20:52:13] Starting t-tests for Light & Shade
    ## INFO [2025-01-30 20:52:14] t-tests performed.
...
sp_vc_plot <- ggplot(sp_volc_data, aes(log2_fc, logP)) +
  ...
  scale_y_continuous(limits = c(0,4), labels = function(i) 10^-i,
                     expand=c(0.003, 0.003)) +
  theme(legend.position = c(0.90, 0.907),
        legend.background = element_rect(fill = "white", color = "black")) +
  theme(panel.grid = element_blank(),
        panel.border = element_rect(fill= "transparent")) +
  #geom_vline(xintercept = 1, linetype = "longdash", colour="gray") +
...
```
    ...
    ## INFO [2025-01-30 20:52:17] Starting homoscedasticity tests.
    ## INFO [2025-01-30 20:52:17] Homoscedasticity tests performed.
...
```
    ...
    ## INFO [2025-01-30 20:52:21] Starting homoscedasticity tests.
    ## INFO [2025-01-30 20:52:21] Homoscedasticity tests performed.
...
![](Multivariate_Statistics_files/figure-gfm/unnamed-chunk-51-1.png)<!-- -->
...
![](Multivariate_Statistics_files/figure-gfm/unnamed-chunk-56-1.png)<!-- -->
...
![](Multivariate_Statistics_files/figure-gfm/unnamed-chunk-61-1.png)<!-- -->
...
![](Multivariate_Statistics_files/figure-gfm/unnamed-chunk-66-1.png)<!-- -->
...
![](Multivariate_Statistics_files/figure-gfm/unnamed-chunk-73-1.png)<!-- -->
...
![](Multivariate_Statistics_files/figure-gfm/unnamed-chunk-78-1.png)<!-- -->
...
```
    ...
    ## INFO [2025-01-30 20:52:48] Finished analysis. Thu Jan 30 20:52:48 2025
    ## Session info:
    ## 
    ## INFO [2025-01-30 20:52:48] R version 4.4.1 (2024-06-14 ucrt)
    ## INFO [2025-01-30 20:52:48] Platform: x86_64-w64-mingw32/x64
    ## INFO [2025-01-30 20:52:48] Running under: Windows 7 x64 (build 7601) Service Pack 1
