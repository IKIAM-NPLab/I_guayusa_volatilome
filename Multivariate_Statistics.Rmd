...
figure_s1a <- ggplot(scores,
                     aes(PC1, PC2, shape = Light_in_subQC,
                         color = Light_in_subQC)) +
  scale_color_manual(values=c("#F5BC5CFF", "#7CAE00", "#00BFC4", "#32373AFF")) +
  scale_shape_manual(values=c(8, 1, 15, 8)) +
  geom_point(size = 3) +
...
figure_s1b <- ggplot(scores,
                     aes(PC1, PC2, shape = Age_in_subQC,
                         color = Age_in_subQC)) +
  scale_color_manual(values=c("#E76BF3", "#4457A5FF", "#F8766D", "#7CAE00", "#00BFC4")) +
  scale_shape_manual(values=c(17, 17, 17, 1, 15)) + 
  geom_point(size = 3) +
  guides(x=guide_axis(title = "PC1 (15.52 %)"),
         y=guide_axis(title = "PC2 (13.45 %)")) +
...
figure_s1c <- ggplot(scores,
                     aes(PC1, PC2, shape = Location_in_subQC,
                         color = Location_in_subQC)) +
  scale_color_manual(values=c("#00B0F6", "#F8766D", "#7CAE00", "#00BFC4", "#E76BF3")) +
#  scale_color_manual(values=c("#F8766D", "#A3A500", "#E76BF3", "#00BF7D", "#00B0F6")) +
  scale_shape_manual(values=c(7, 7, 1, 15, 7)) + 
  geom_point(size = 3) +
  guides(x=guide_axis(title = "PC1 (15.52 %)"),
         y=guide_axis(title = "PC2 (13.45 %)")) +
