...
We improve heatmap visualization by adding the Tukey test as row annotation. The code of the Tukey test calculation is available in the ["univariate statistics notebook](https://doi.org/10.3390/metabo10040135).
...
# Adding tukey test result
hm_age_spl <- join_fData(hm_age_spl, tk_spl_result)
