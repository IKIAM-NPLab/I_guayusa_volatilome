...
data <- read_from_excel(file = "Data/Data_to_notame/MZmine_Feature_List_2notame.xlsx", sheet = 1, 
                        corner_row = 6, corner_column = "J", 
...
# PCA plot
ggplot(scores,
       aes(PC1, PC2, shape = Light_condition, color = Light_condition)) +
  geom_point(size = 3) +
  guides(x=guide_axis(title = "PC1 (15.41 %)"),
         y=guide_axis(title = "PC2 (12.60 %)")) +
  theme_classic() +
