...
ggplot(loadings, aes(PC1, PC2)) + 
  ...
  geom_point(data = ei_compouds,
             aes(shape = feat_data$Identification_level, color = feat_data$Identification_level),
             size = 2) +
  labs(shape = 'Identification level', color = 'Identification level') +
...
# Save plot
ggsave('Result/notame_Result/GCMS_Loadings_all.pdf', width = 20, height = 10.5, device='pdf', dpi="print")
