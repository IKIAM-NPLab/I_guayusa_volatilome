...
Procedemos a la desconvolución de compuestos en los datos experimentales (raw_data) utilizando los parámetros especificados en "dec_par" los resultados obtenidos seran guardados en (dec_par).
