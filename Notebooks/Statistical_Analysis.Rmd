---
title: "Effect of age and light on the volatile profile of *Ilex guayusa* leaves - Statistical analysis"
...
```{r echo=TRUE, message=FALSE, warning=FALSE, error=FALSE, fig.width = 9.5, fig.height = 9}
...
All metabolites showed equality of variances according to the Levene's test. The next step will be the ANOVA test.
...
To statistically evaluate the PCA results, a permutational multivariate analysis of variance (PERMANOVA) was conducted.
